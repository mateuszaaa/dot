...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lsp-signature-help"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp-signature-help",
  ...
  ["fidget.nvim"] = {
    ...
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/fidget.nvim",
    url = "https://github.com/j-hui/fidget.nvim"
  },
  fzf = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/fzf",
    url = "https://github.com/junegunn/fzf"
  },
  ["fzf.vim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/fzf.vim",
    url = "https://github.com/junegunn/fzf.vim"
  },
  ["hop.nvim"] = {
    config = { "\27LJ\2\n1\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\bhop\frequire\0" },
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/hop.nvim",
  ...
  ["monokai.nvim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/monokai.nvim",
  ...
  ["octo.nvim"] = {
    ...
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/octo.nvim",
  ...
  ["rust-tools.nvim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/rust-tools.nvim",
    url = "https://github.com/simrat39/rust-tools.nvim"
  },
  tcomment_vim = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/tcomment_vim",
  ...
  ["telescope-ui-select.nvim"] = {
    ...
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/telescope-ui-select.nvim",
  ...
  ["trouble.nvim"] = {
    config = { "\27LJ\2\n…\1\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\4\14auto_fold\1\tmode\25document_diagnostics\17auto_preview\1\25use_diagnostic_signs\1\nsetup\ftrouble\frequire\0" },
    loaded = true,
  ...
  ["vim-gh-line"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/vim-gh-line",
  ...
  ["vim-highlightedyank"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/vim-highlightedyank",
    url = "https://github.com/machakann/vim-highlightedyank"
  },
  ["vim-sleuth"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/vim-sleuth",
  ...
  vim_current_word = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/vim_current_word",
